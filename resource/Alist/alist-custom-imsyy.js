...
const customFooter = (el) => {
  try {
    if (el !== null) {
      el.innerHTML = `<div class="text"><div class="num">Themed by <a href="https://imsyy.top/" target="_blank">無名</a> | Powered by <a href="https://alist.nn.ci/zh/" target="_blank">Alist</a></i></span></div><div class="power">Copyright © 2020 - ${new Date().getFullYear()} <a href="https://ykwang.top/" target="_blank">ykwang</a></div></div></div>`;
    }
  } catch (error) {
